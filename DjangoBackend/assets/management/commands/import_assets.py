...
from EVEATS.assets.models import *
...
class Command(BaseCommand):
	...
	def handle(self, *args, **options):
		...
		if eve_api_response.status == 200:
			os.remove("/home/eveats/EVEATS/assets/management/xml_cache/corpAssetList.xml")
					
			assets_xml_file = open("/home/eveats/EVEATS/assets/management/xml_cache/corpAssetList.xml", "w")
		...
		try:
			assets_xml_file = open("/home/eveats/EVEATS/assets/management/xml_cache/corpAssetList.xml", "r")
